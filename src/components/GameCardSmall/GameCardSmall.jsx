...
export default function GameCardS({
  ...
  return (
    <div className="group relative rounded-lg overflow-hidden border-2 border-(--color-a-amber) flex flex-col cursor-pointer">
      ...
      <div className="bg-(--color-p-bg) px-3 py-2 flex items-center cursor-auto">
